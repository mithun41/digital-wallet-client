...
const Subscription = () => {
  ...
  return (
    <div
      className="max-w-10/12 mx-auto py-12 mt-8 px-6 md:px-16 rounded-2xl flex flex-col md:flex-row items-center justify-between 
    ...
    >
      ...
      <div className="text-center md:text-left mb-6 md:mb-0">
        ...
        <p className="text-gray-600 dark:text-gray-300 mt-2 text-sm md:text-base">
          Get exclusive wallet updates, offers, and tips directly to your inbox.
        </p>
      </div>
      ...
      <div className="flex items-center w-full md:w-auto gap-2">
        ...
        {success && (
          <div className="flex items-center text-green-600 ml-3 animate-fadeIn">
