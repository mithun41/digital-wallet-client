...
export default function CashOut() {
    ...
    const nearbyAgents = [
        ...
        { name: "Musaddek Hossain Summon", distance: "300m", number: "01612345681", available: true, rating: 4.9, verified: true },
    ];
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 w-screen max-w-none">
            {/* Modern Header with Glassmorphism */}
            <div className="relative bg-gradient-to-r bg-[#155DFC] overflow-hidden w-full">
                <div className="absolute inset-0 bg-white/10 backdrop-blur-sm"></div>
                <div className="relative px-4 sm:px-6 lg:px-8 py-6 flex items-center justify-between text-white max-w-none w-full">
                ...
                {/* Progress Indicator */}
                <div className="relative px-4 sm:px-6 lg:px-8 pb-4 w-full">
            ...
            <div className="px-4 sm:px-6 lg:px-8 py-8 space-y-8 w-full max-w-none">
                            ...
                            <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 mb-8">
                                ...
                                <div className="border-t-2 border-gray-100 pt-6">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                                        {nearbyAgents.slice(0, 4).map((agent, index) => (
                                            <button
                                                key={index}
            ...
            {/* Enhanced Bottom Bar */}
            <div className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-lg border-t border-gray-200 px-6 py-4 shadow-2xl w-full">
