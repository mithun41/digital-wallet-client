...
//               Subscribe to our newsletter and get the latest digital wallet insights delivered to your inbox
//             </p>
...
//                 className="flex-1 px-6 py-4 rounded-full text-gray-900 dark:text-white bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-white"
//               />
//               <button className="px-8 py-4 bg-white text-blue-600 rounded-full font-bold hover:shadow-xl transform hover:scale-105 transition-all whitespace-nowrap">
//                 Subscribe
//               </button>
//             </div>
//           </div>
...
//                 </div>
//                 <span className="text-2xl font-bold text-white">WalletHub</span>
//               </div>
//               <p className="text-gray-400">Your trusted digital wallet solution for all your payment needs.</p>
//             </div>
...
//             <p>&copy; 2025 WalletHub. All rights reserved.</p>
//           </div>
//         </div>
//       </footer>
//     </div>
