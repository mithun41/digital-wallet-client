    ...
    return (
        <section className="py-10">
            <div className="max-w-11/12 mx-auto text-center px-4">
                ...
                <p className="max-w-10/12 mx-auto mb-10" data-aos="fade-up">
                    ...
                    {steps.map((step) => (
                        <div key={step.id}>
                            ...
                            >
                                ...
                                <div className="p-6">
                                    <h3 className="text-lg font-semibold mb-2 max-w-10/12 mx-auto">
                                        {step.title}
                                    </h3>
                                    <p className="text-sm max-w-10/12 mx-auto">{step.description}</p>
                                </div>
                            </div>
                        </div>
                    ))}
